...
class _remote(plugin._plugin):
    ...
    def install(self):
        ...
        model.registerModel("remoteDownloadConfig","_remoteDownloadConfig","_action","plugins.remote.models.action")
        return True
    ...
    def uninstall(self):
        ...
        model.deregisterModel("remoteDownloadConfig","_remoteDownloadConfig","_action","plugins.remote.models.action")
        return True
